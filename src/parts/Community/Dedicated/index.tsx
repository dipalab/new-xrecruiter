...
import FirstSlideImage from '../../../assets/images/community/slide-1.png'
import SecondSlideImage from '../../../assets/images/community/slide-2.png'
import ThirdSlideImage from '../../../assets/images/community/slide-3.png'
        ...
        <div className="relative py-16 md:py-24 xl:pb-[112px] xl:pt-[120px]">
          <div className="px-6 lg:px-10 xl:px-0 mx-auto max-w-7xl">
            <div ref={TitleRef} className="text-center max-w-[960px] mx-auto">
              <TitleText>Dedicated space for <br /> Learning & Development</TitleText>
            </div>
