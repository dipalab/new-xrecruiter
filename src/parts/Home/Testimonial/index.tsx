...
const Testimonial = () => {
  ...
  FadeYAnimation({ animationRef: FirstCardRef, scrollTriggerRef: CardRef, initialValue: -90, delayValue: 0, durationValue: 0.8 })
  FadeYAnimation({ animationRef: SecondCardRef, scrollTriggerRef: CardRef, initialValue: -90, delayValue: 0.3, durationValue: 0.8 })
  FadeYAnimation({ animationRef: ThirdCardRef, scrollTriggerRef: CardRef, initialValue: -90, delayValue: 0.6, durationValue: 0.8 })

  const [openTab, setOpenTab] = useState(TestimoniTabName.INDUSTRY_TALENT)

  return (
    <>
      <div className="bg-[#8738FF] h-[892px] py-16 md:py-24 xl:pb-12 xl:pt-[120px]">
        <div className="px-6 lg:px-10 xl:px-0 mx-auto max-w-7xl">
          ...
          <div className="mt-12 md:mt-14 xl:mt-16">
                  ...
                  <div ref={CardRef} className="relative w-full h-full max-w-[622px] xl:max-w-[766px] mx-auto">
                    ...
                    <div ref={FirstCardRef} className="relative p-6 md:p-8 xl:p-10 w-full bg-white rounded-[32px] xl:rounded-[40px] shadow-[0px_4px_40px_rgba(0,_0,_0,_0.12)]">
                      ...
                      <div className="my-8 xl:my-10">
                        ...
                        <p className="mt-4 font-cera-pro-regular text-sm xl:text-base text-neutral-60">{ item.body }</p>
                      </div>
            ...
            {/* tabs */}
            <div className="flex justify-center mt-16 md:mt-[72px] xl:mt-[88px]">
