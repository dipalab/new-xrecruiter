...
import ConnectImage from '../../../assets/images/home/connect.svg'
    ...
    <>
      <div className="bg-white py-16 md:pt-[80px] md:pb-[88px] xl:py-[120px]">
        <div className="px-6 lg:px-10 xl:px-0 mx-auto max-w-7xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-6 mt-4">
            <div className="flex flex-col justify-center">
              <TitleText classNames="!text-left">Connect <span className="inline-flex w-[50px] md:w-[72px] h-6 md:h-8 relative"><img src={ConnectAvaImage} alt="" className="absolute -bottom-2 w-auto h-8 md:h-10" /></span>, Grow and Succeed on your own terms.</TitleText>
