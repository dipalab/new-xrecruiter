  ...
  return (
    <>
      <div className="relative overflow-hidden bg-[#00081D]">
        {/* xr logo background */}
        <div className="absolute flex justify-end w-full h-full pt-[180px] md:pt-[56px] xl:pt-[60px]">
        ...
        {/* hero content */}
        <div className="relative mx-auto max-w-7xl text-center pb-[130px] md:pb-[280px] lg:pb-[305px] xl:pb-[340px] pt-[48px] md:pt-[88px] xl:pt-[136px] px-11 lg:px-10 xl:px-0">
