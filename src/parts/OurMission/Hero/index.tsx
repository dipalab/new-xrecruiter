...
const Hero = () => {
  ...
  FadeYAnimation({ animationRef: LogoRef, scrollTriggerRef: LogoRef, initialValue: 90, delayValue: 0.5, durationValue: 0.8 })
  ...
  return (
    <>
      <div className="relative isolate overflow-hidden h-[700px] md:h-[600px] xl:h-[854px] max-w-[1920px] mx-auto">
        <LazyLoadImage
          src={HeroImage}
          className="absolute inset-0 -z-10 h-full w-full object-right object-cover hidden sm:block"
          alt=""
        />
        <LazyLoadImage
          src={HeroMobileImage}
          className="absolute inset-0 -z-10 h-full w-full object-right object-cover sm:hidden"
          alt=""
        />

        <div className="mx-auto max-w-7xl pt-[88px] md:pt-[136px] xl:pt-[210px]">
