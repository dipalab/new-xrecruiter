        ...
        <div className="px-6 lg:px-10 xl:px-0 mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-0">
            ...
            <div className="flex flex-col justify-center md:-ml-3.5 xl:-ml-0">
              <p ref={TitleRef} className="text-2xl leading-9 md:text-[32px] md:leading-[40px] text-neutral-100 font-cera-pro-medium">We believe that hard work should pay off and it’s our vision to build a future where the next generation of recruiters can connect, grow and succeed, on their own terms.</p>
            </div>
          </div>
        </div>
      </div>
